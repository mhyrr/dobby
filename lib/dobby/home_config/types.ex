defmodule Dobby.HomeConfig.Types do
  ...
  @modules [
    ...
    Dobby.DeviceAgents.Washer,
    Dobby.DeviceAgents.Dryer,
    Dobby.DeviceAgents.WaterHeater,
    Dobby.DeviceAgents.Humidifier,
    Dobby.DeviceAgents.Dehumidifier,
    Dobby.DeviceAgents.AirPurifier,
    Dobby.DeviceAgents.RangeHood,
    Dobby.DeviceAgents.CoffeeMaker,
    Dobby.DeviceAgents.WineCooler,
    Dobby.DeviceAgents.IceMaker,
    Dobby.DeviceAgents.Cooktop,
    Dobby.DeviceAgents.Microwave,
